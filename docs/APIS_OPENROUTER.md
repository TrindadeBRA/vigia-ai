...
Vai em `OPENROUTER_API_KEY` no painel web (persistido em `collector/data/config.json`, gitignored). Sem fallback de app local, porque o OpenRouter não roda nada instalado neste Mac.
