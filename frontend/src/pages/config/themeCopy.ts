...
export const THEME_STR: Record<Lang, ThemeCopy> = {
  pt: {
    ...
    deleteHint: "Dica: as setas movem o elemento (Shift anda mais); Delete remove.",
  ...
  en: {
    ...
    deleteHint: "Tip: arrow keys move the element (Shift moves farther); Delete removes it.",
  ...
  es: {
    ...
    deleteHint: "Consejo: las flechas mueven el elemento (Shift recorre más); Supr lo quita.",
