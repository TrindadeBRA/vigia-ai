...
export type ConfigCopy = {
  ...
  boardLead: string;
  boardUrlHint: string;
  boardFlashTitle: string;
  boardFlashLead: string;
  boardFlashUsb: string;
  boardFlashReady: string;
  boardAdvanced: string;
  boardAdvancedLead: string;
  ...
  boardSsid: string;
  boardSsidHint: (ssid: string) => string;
  ...
  boardFlash: string;
  boardFlashing: string;
  boardFlashOk: string;
  boardFlashFail: string;
  flashCmdLabel: string;
  boardLogLabel: string;
...
export const CONFIG_STR: Record<Lang, ConfigCopy> = {
  pt: {
    ...
    boardTitle: "Wi-Fi da placa",
    boardLead: "A ESP32 entra nesta rede para achar o coletor. O endereço é preenchido sozinho; a senha você digita uma vez.",
    boardUrlHint: "IP deste computador na LAN — nunca 127.0.0.1, a placa não alcança o loopback.",
    boardFlashTitle: "Gravar o firmware",
    boardFlashLead: "Plugue o cabo USB neste computador. Isso grava o secrets.h e sobe o programa na ESP32.",
    boardFlashUsb: "Conecte a placa por USB. É preciso PlatformIO (pio) neste Mac, fora do Docker.",
    boardFlashReady: "Pronto para gravar. A placa precisa estar no cabo USB.",
    boardAdvanced: "Outras formas (arquivo e terminal)",
    boardAdvancedLead: "Se preferir gravar à mão: baixe o secrets.h, coloque na pasta do firmware e rode o comando.",
    boardDownload: "Baixar secrets.h",
    boardDownloading: "Preparando…",
    boardOk: "Arquivo baixado. Se for gravar à mão, coloque em firmware/src/secrets.h.",
    ...
    boardSsid: "Wi-Fi (SSID)",
    boardSsidHint: (ssid) => `Rede deste computador: ${ssid}`,
    ...
    boardFlash: "Gravar na ESP32",
    boardFlashing: "Gravando…",
    boardFlashOk: "Firmware gravado na placa.",
    boardFlashFail: "Não deu para gravar. Confira o cabo USB, o pio e o log.",
    flashCmdLabel: "No terminal",
    boardLogLabel: "Log da gravação",
    ...
    howTitle: "Como fazer",
    howLead: "Preencha a Wi-Fi da placa e grave o firmware pelo USB. Tokens ficam neste computador — a ESP32 só pede JSON na LAN.",
    ...
    how3Title: "Preencha a Wi-Fi da placa",
    how3Body: "O painel detecta o nome da rede e o IP deste computador. Digite a senha da Wi-Fi uma vez — o coletor grava firmware/src/secrets.h.",
    how4Title: "Grave o firmware",
    how4Body: "Plugue o cabo USB e use “Gravar na ESP32” nesta página. Sem placa física, use o simulador no passo abaixo. No terminal continua valendo ./dev firmware flash.",
    ...
    simTitle: "Sem placa física (simulador)",
    ...
    spotifyAddCardHint: "Conectado! O card já aparece sozinho em /display — use o \"No painel\" acima pra esconder.",
    ...
    ytmusicAddCardHint: "Conectado! O card já aparece sozinho em /display — use o \"No painel\" acima pra esconder.",
    ...
    checkTitle: "Conferir as cotas",
    checkLead: "Testa se o coletor responde. Faça isso depois de gravar a placa, ou para achar conta quebrada.",
    ...
    cameraPort: "PORTA",
    cameraPath: "CAMINHO RTSP (opcional)",
  ...
  en: {
    ...
    boardTitle: "Board Wi-Fi",
    boardLead: "The ESP32 joins this network to reach the collector. The address is filled in for you; type the password once.",
    boardUrlHint: "This computer's LAN IP — never 127.0.0.1; the board cannot reach loopback.",
    boardFlashTitle: "Flash the firmware",
    boardFlashLead: "Plug the USB cable into this computer. This writes secrets.h and uploads the program to the ESP32.",
    boardFlashUsb: "Connect the board over USB. PlatformIO (pio) must be installed on this Mac, not in Docker.",
    boardFlashReady: "Ready to flash. The board must be on the USB cable.",
    boardAdvanced: "Other options (file and terminal)",
    boardAdvancedLead: "To flash by hand: download secrets.h, put it in the firmware folder, and run the command.",
    boardDownload: "Download secrets.h",
    boardDownloading: "Preparing…",
    boardOk: "File downloaded. If you flash by hand, put it in firmware/src/secrets.h.",
    ...
    boardSsid: "Wi-Fi (SSID)",
    boardSsidHint: (ssid) => `This computer's network: ${ssid}`,
    ...
    boardFlash: "Flash ESP32",
    boardFlashing: "Flashing…",
    boardFlashOk: "Firmware written to the board.",
    boardFlashFail: "Flash failed. Check the USB cable, pio, and the log.",
    flashCmdLabel: "In the terminal",
    boardLogLabel: "Flash log",
    ...
    howLead: "Fill in the board Wi-Fi and flash the firmware over USB. Tokens stay on this computer — the ESP32 only asks for JSON on the LAN.",
    ...
    how3Title: "Fill in the board Wi-Fi",
    how3Body: "The panel detects this computer's network name and IP. Type the Wi-Fi password once — the collector writes firmware/src/secrets.h.",
    how4Title: "Flash the firmware",
    how4Body: "Plug in USB and use “Flash ESP32” on this page. No physical board? Use the simulator below. The terminal command is still ./dev firmware flash.",
    ...
    simTitle: "No physical board (simulator)",
    ...
    spotifyAddCardHint: "Connected! The card already shows up on /display — use \"On display\" above to hide it.",
    ...
    ytmusicAddCardHint: "Connected! The card already shows up on /display — use \"On display\" above to hide it.",
    ...
    checkTitle: "Check usage",
    checkLead: "Tests that the collector responds. Do this after flashing, or to spot a broken account.",
  ...
  es: {
    ...
    boardTitle: "Wi-Fi de la placa",
    boardLead: "La ESP32 entra en esta red para encontrar el colector. La dirección se completa sola; la contraseña la escribes una vez.",
    boardUrlHint: "IP de este computador en la LAN — nunca 127.0.0.1; la placa no alcanza el loopback.",
    boardFlashTitle: "Grabar el firmware",
    boardFlashLead: "Conecta el USB a este computador. Esto escribe secrets.h y sube el programa a la ESP32.",
    boardFlashUsb: "Conecta la placa por USB. Hace falta PlatformIO (pio) en este Mac, fuera de Docker.",
    boardFlashReady: "Lista para grabar. La placa tiene que estar en el cable USB.",
    boardAdvanced: "Otras formas (archivo y terminal)",
    boardAdvancedLead: "Si prefieres grabar a mano: descarga secrets.h, ponlo en la carpeta del firmware y ejecuta el comando.",
    boardDownload: "Descargar secrets.h",
    boardDownloading: "Preparando…",
    boardOk: "Archivo descargado. Si grabas a mano, ponlo en firmware/src/secrets.h.",
    ...
    boardSsid: "Wi-Fi (SSID)",
    boardSsidHint: (ssid) => `Red de este computador: ${ssid}`,
    ...
    boardFlash: "Grabar en la ESP32",
    boardFlashing: "Grabando…",
    boardFlashOk: "Firmware grabado en la placa.",
    boardFlashFail: "No se pudo grabar. Revisa el cable USB, pio y el registro.",
    flashCmdLabel: "En el terminal",
    boardLogLabel: "Registro de la grabación",
    ...
    howLead: "Completa el Wi-Fi de la placa y graba el firmware por USB. Los tokens quedan en este computador — la ESP32 solo pide JSON en la LAN.",
    ...
    how3Title: "Completa el Wi-Fi de la placa",
    how3Body: "El panel detecta el nombre de la red y la IP de este computador. Escribe la contraseña del Wi-Fi una vez — el colector escribe firmware/src/secrets.h.",
    how4Title: "Graba el firmware",
    how4Body: "Conecta el USB y usa “Grabar en la ESP32” en esta página. Sin placa física, usa el simulador más abajo. En el terminal sigue valiendo ./dev firmware flash.",
    ...
    simTitle: "Sin placa física (simulador)",
    ...
    spotifyAddCardHint: "¡Conectado! La card ya aparece sola en /display — usá \"En el panel\" arriba para ocultarla.",
    ...
    ytmusicAddCardHint: "¡Conectado! La card ya aparece sola en /display — usá \"En el panel\" arriba para ocultarla.",
    ...
    checkTitle: "Comprobar las cuotas",
    checkLead: "Prueba si el colector responde. Hazlo después de grabar la placa, o para encontrar una cuenta rota.",
