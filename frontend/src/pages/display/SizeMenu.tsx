...
export function SizeIcon({ size, className }: { size: CardSize; className?: string }) {
  ...
  {/* wl = 2 col × 8 lin (estreito e bem alto), wxl = largura da tela × 8 lin (bem largo) — ícones opostos de propósito, senão ficam indistinguíveis no menu */}
  if (s === "wl") return <span className={cn("mx-auto grid h-[11px] w-[5px] grid-rows-4 gap-px", className)}><span className="rounded-[1px] border-[1.4px] border-current" /><span className="rounded-[1px] border-[1.4px] border-current" /><span className="rounded-[1px] border-[1.4px] border-current" /><span className="rounded-[1px] border-[1.4px] border-current" /></span>;
  if (s === "wxl") return <span className={cn("my-auto grid h-[5px] w-[11px] grid-cols-4 gap-px", className)}><span className="rounded-[1px] border-[1.4px] border-current" /><span className="rounded-[1px] border-[1.4px] border-current" /><span className="rounded-[1px] border-[1.4px] border-current" /><span className="rounded-[1px] border-[1.4px] border-current" /></span>;
...
export function TileChrome({
  ...
  return (
    <>
      ...
      <div data-gamepad-chrome="true" className={cn("absolute right-1 z-[3] flex items-center rounded-lg border border-edge bg-chip", isQuarter ? "bottom-1" : "top-1", TILE_CHROME_CHIP)}>
